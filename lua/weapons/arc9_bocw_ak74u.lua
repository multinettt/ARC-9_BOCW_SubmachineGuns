...
SWEP.PhysBulletMuzzleVelocity = 383 * 39.37
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_ak74u_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.AimDownSightsTime = 0.300 -- How long it takes to go from hip fire to aiming down sights.
...
SWEP.ShootSound = "ARC9_BOCW.AK74u_fire"
--SWEP.ShootSoundIndoor = "ARC9_BOCW.AK74u_fire_int_decay"                  -- Fire indoors
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "tag_weapon",
        Pos = Vector(-10.5, -4.42, 6.15),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(20.25, 4.5, -5),
        Category = {"bocw_ak74u_underbarrel", "bocw_smg_underbarrel_east"},
    },
    {
        PrintName = "MAGAZINE",
        Bone = "tag_clip",
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_ak74u_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_ak74u_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3", 
...
local CustomSlotTable = {
    ...
    Pos = Vector(0, 0, 0),
    Ang = Angle(0, 0, 0),
    Icon_Offset = Vector(-4, 0, 1.75),
    Category = {"bocw_custom_slot", "bocw_custom_slot_ak74u"},
}
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.AK74u_boltback", t = 0.2 },
            { s = "ARC9_BOCW.AK74u_boltrelease", t = 0.4 },
            { s = "ARC9_BOCW.AK74u_reload_end", t = 0.7 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_ext"] = {
        ...
        MinProgress = 0.7,
        EventTable = {
            { s = "ARC9_BOCW.AK74u_reload_ext_magout", t = 0.2 },
    ...
    ["reload_empty_ext"] = {
        ...
        EventTable = {
            { s = "ARC9_BOCW.AK74u_reload_ext_magout", t = 0.2 },
            { s = "ARC9_BOCW.AK74u_reload_ext_maggrab", t = 0.9 },
            { s = "ARC9_BOCW.AK74u_reload_ext_magin", t = 1.5 },
    ...
    ["reload_empty_mix"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.AK74u_reload_maggrab", t = 0.9 },
            { s = "ARC9_BOCW.AK74u_reload_magin", t = 1.5 },
            { s = "ARC9_BOCW.AK74u_boltback", t = 2.2 },
            { s = "ARC9_BOCW.AK74u_boltrelease", t = 2.4 },
            { s = "ARC9_BOCW.AK74u_reload_empty_end", t = 2.7 },
            { hide = 1, t = 0 },
