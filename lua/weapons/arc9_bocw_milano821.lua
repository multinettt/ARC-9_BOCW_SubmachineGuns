...
SWEP.SpreadAddHipFire = math.rad(90 / 37.5)
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = {"bocw_milano821_underbarrel", "bocw_smg_underbarrel_west"},
    },
    {
        PrintName = "MAGAZINE",
        Bone = "tag_clip",
...
local CustomSlotTable = {
    ...
    Category = {"bocw_custom_slot", "bocw_custom_slot_milano821"},
}
