...
SWEP.PrintName = "KSP 45"
SWEP.TrueName = "KSP 45"
...
SWEP.Description = [[3-round burst submachine gun. High damage with moderate range. Burst fire spread is less efficient at long range.

The KSP 45 is a burst-fire submachine gun featured in Call of Duty: Black Ops Cold War and Call of Duty: Mobile.]]

SWEP.UseHands = true

SWEP.ViewModel = "models/weapons/arc9/c_arc9_ksp45_bocw.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_arc9_ksp45_bocw.mdl"
...
SWEP.PhysBulletMuzzleVelocity = 265 * 39.37
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_ksp45_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_ksp45_muzzle", "bocw_smg_muzzle_west45"},
        Installed = "bocw_ksp45_muzzle_base",
        Integral = "bocw_ksp45_muzzle_base",
    },
    {
        PrintName = "BARREL",
        Bone = "tag_barrel",
    ...
    },
    {
        ...
        Category = {"bocw_ksp45_body"},
    },
    {
        PrintName = "UNDRBARREL",
        Bone = "tag_weapon",
        Pos = Vector(-10.5, -4.42, 6.55),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(20.25, 4.5, -5),
        Category = {"bocw_ksp45_underbarrel", "bocw_smg_underbarrel_west"},
    },
    {
        PrintName = "MAGAZINE",
        Bone = "tag_clip",
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_ksp45_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_ksp45_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_ksp45_sticker3.mdl",
        CosmeticOnly = true,
    },
}
--=========================================================
...
local CustomSlotTable = {
    ...
    Pos = Vector(0, 0, 0),
    Ang = Angle(0, 0, 0),
    Icon_Offset = Vector(-5, 0, 3.8),
    Category = {"bocw_custom_slot", "bocw_custom_slot_ksp45"},
}
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["ksp45_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["ksp45_mag_fast"] then
        return anim .. "_fast"
    end

    if elements["ksp45_mag_mix"] then
        return anim .. "_mix"
    end
end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.KSP45_boltrelease", t = 0.4 },
            { s = "ARC9_BOCW.KSP45_reload_end", t = 0.7 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.KSP45_reload_magin", t = 1.2 },
